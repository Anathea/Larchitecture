...
<html lang="fr">
  ...
  <body>
    ...
    <div class="main">
      ...
      <section class="section-appel-offre">
        <h2 class="section-appel-offre__title">
          Appel d'offre
        </h2>

        <iframe src="http://www.doubletrade.com" width="1018px" height="1000px" class="section-appel-offre__iframe">
